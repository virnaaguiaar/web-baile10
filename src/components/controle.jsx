...
function Controle({ robotsPose = {}, robotId = 'robo1', onRobotIdChange = () => {} }) {
    ...
    // Tópico: "cmd/robo1" para robô específico, "cmd" para todos
    // REQUER firmware MQTT_WEBSOCKET.h atualizado gravado na ESP32
...
export default Controle;import React, { useState, useCallback } from 'react';
import { useMQTT } from '../hooks/useMQTT';
import Cima     from '../assets/seta_up.png';
import Esquerda from '../assets/seta_left.png';
import Direita  from '../assets/seta_rigth.jpg';
